...
public class Player {
	...
	public String toString() {
		...
		for(int i = 0;i < data.size(); i++) {		
			...
			case "ground":				
				data.add("Type : "+this.cards.get(i).getType()+", "+"Name : "+this.cards.get(i).getName()+"Score : "+this.cards.get(i).getScore()+", "+"Life : "+this.cards.get(i).getLife()+", "+"Attack : "+this.cards.get(i).getAttack());
				break;
			case "magic":				
				data.add("Type : "+this.cards.get(i).getType()+", "+"Name : "+this.cards.get(i).getName()+"Score : "+this.cards.get(i).getScore()+", "+"Life : "+this.cards.get(i).getLife()+", "+"Attack : "+this.cards.get(i).getAttack());
				break;
